...
{
  // 表名
  public $table = "module_teacher_share_money_extract";
  ...
  {
    return ShareEnum::getTypeStatus($value);
  }
   ...
   * @return 状态信息
   */
  public function getSettlementTimeAttribute($value)
  {
    return TimeEnum::getDateTime($value);
  }
